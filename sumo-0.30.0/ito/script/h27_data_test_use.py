...
if 'SIM_SUPPORT_ENV' in os.environ:
    ...
    #from inoki_app.human_in_veh import HumanInVeh
...
def assign_mobile_agent(veh):
    ...
    return ExtendedMobileAgent(agent_id, veh, [AppInVeh('127.0.0.1', 4000)], ExtendedRoutine(lag))
...
PORT = 8873
SUMOCFG_FILE = '../data/ito_h27_flow_data.sumocfg'
...
if __name__ == '__main__':
    ...
    # manager.setting_poi()
    #manager.end_step(43500)
    #manager.end_step(7000)
    manager.end_step(45000)
